...
/**
 * Class TeapotException is a {@code sample} exception that sets the response status to a dummy code
 *
 * @author T.N.Silverman
 */
@ResponseStatus(value = HttpStatus.I_AM_A_TEAPOT, reason = "You're a teapot! (this is a sample demo exception)") // 418
