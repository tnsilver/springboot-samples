 ...
 */
public class SocialSecurityNumber implements Serializable, Comparable<SocialSecurityNumber> {
    ...
    public SocialSecurityNumber(String ssn) {
        ...
        try {
            ...
            logger.debug("cannot set ssn {}", ssn);
            this.area = null;
            this.group = null;
            this.serial = null;
            this.ssn = null;
    ...
    public void setSsn(String ssn) {
        if (Objects.requireNonNullElse(ssn, "").isBlank())
            return;
        try {
            area = Integer.parseInt(ssn.substring(0, 3));
            group = Integer.parseInt(ssn.substring(4, 6));
            ...
            logger.debug("cannot set ssn {} becuase {} -> {}", ssn, ex.getClass().getTypeName(), ex.getMessage());
            this.area = null;
            this.group = null;
            this.serial = null;
            this.ssn = null;
    ...
    public int compareTo(SocialSecurityNumber other) {
        if (null == other || null == other.getSsn())
            return 1;
        return this.getSsn().compareTo(other.getSsn());
    }
}
