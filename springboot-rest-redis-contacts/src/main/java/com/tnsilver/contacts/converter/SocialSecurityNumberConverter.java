...
/**
 * Class SocialSecurityNumberConverter represents a social security number with area/group/serial notation meaning a
 * social security number is composed of a group of 3 digits, then dash, then 2 digits, then a final dash, and then
 * another group of 4 digits.
 *
