...
public class RestTemplateApiTest extends BaseRedisTest {
    ...
    public void beforeEach(TestInfo info) throws Exception {
        ...
        homer = new Contact(new SocialSecurityNumber("678-21-4301"), "Homer", "Simpson", LocalDate.parse("1978-06-20"), Boolean.TRUE, 3);
        tester = new Contact(new SocialSecurityNumber("555-55-5555"), "Test", "Tester", LocalDate.now(), Boolean.FALSE, 0);
        flushAndPopulate();
    }

    /** RestTemplate GET requests: with a quick example using the getForEntity() API */
    @Test
    @DisplayName("test get for contact entities")
    ...
    public void whenExchangeForStringResponse_ThenGetExpectedContactsInResponse() throws Exception {
        List<Contact> contacts = exchangeForList(restTemplate, restApiEndPoint + "?page=0&size=34&sort=id,ASC", "contacts");
    ...
    public void whenPatchContact_ThenContactIsUpdated() throws Exception {
        ...
        // @formatter:off
        String json = "{\"ssn\": \"555-55-5555\",\"firstName\": \"Tset\", \"lastName\": \"Retset\","
                    + "\"birthDate\": \"1980-06-20\",\"married\": false,\"children\": 0}";
