...
@SpringBootTest
//@DirtiesContext
public class MockMvcApiTest extends BaseRedisTest {
    ...
    public void whenGetContacts_ThenCorrectStatusAndContentTypeAndSize() throws Exception {
        // @formatter:off
        mockMvc.perform(get(restApiEndPoint).param("size", "34"))
            /*.andDo(print())*/
    ...
    public void whenPostContact_ThenCorrectValuesAndStatus() throws Exception {
        Contact contact = new Contact(new SocialSecurityNumber("123-45-6789"), "Test", "Contact", LocalDate.parse("1980-02-06"), Boolean.TRUE, 3);
        String json = json(contact);
        logger.debug("saving contact ", json);
        // @formatter:off
        MvcResult result = mockMvc.perform(post(restApiEndPoint).contentType(contentType).content(json))
                /*.andDo(print())*/
        ...
        mockMvc.perform(delete(restApiEndPoint + "/" + id).contentType(contentType).content(json))
               /*.andDo(print())*/
    ...
    public void whenPutContact_ThenCorrectValuesAndStatus() throws Exception {
        ...
        Contact contact = new Contact(new SocialSecurityNumber("678-21-4301"), "Homer", "Simpson", LocalDate.parse("1978-06-20"), Boolean.FALSE, 0);
        String json = json(contact);
