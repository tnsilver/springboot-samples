 ...
 * {@link TypeConstrainedMappingJackson2HttpMessageConverter} message converter
 * for {@code test} profile
 *
...
public class TestRestTemplateConfig {
	...
	TestRestTemplate testRestTemplate(RestTemplateBuilder restTemplateBuilder) {
		 ...
		 *
		 * I/O error on PATCH request for http://localhost:8080/users: Invalid HTTP
		 * method: PATCH; nested exception is java.net.ProtocolException: Invalid HTTP
		 * method: PATCH
		 *
		 * This happens because of the HttpURLConnection used by default in Spring Boot
		 * RestTemplate which is provided by the standard JDK HTTP library.
		 *
